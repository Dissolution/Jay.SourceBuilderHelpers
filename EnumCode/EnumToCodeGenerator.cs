...
public class EnumToCodeGenerator : IIncrementalGenerator
{
    ...
    private static string GenerateMainExtensionsClass()
    {
        ...
        text.AppendLine("// <auto-generated/>")
            ...
            .AppendLine("{")
            .Append(tab).AppendLine("public static string ToEnumCode<T>(this T? value)")
            .Append(tab).AppendLine("{")
            .Append(tab).Append(tab).AppendLine("return value?.ToString() ?? \"\";")
            .Append(tab).AppendLine("}")
            .AppendLine("}");
